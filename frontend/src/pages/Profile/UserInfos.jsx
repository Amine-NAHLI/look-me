...
const UserInfos = () => {
  ...
  const handleUpdateProfile = async (e) => {
    ...
    setLoading(true);
    try {
      const { data } = await api.put('/auth/me', { firstName: formData.firstName, phone: formData.phone || undefined });
      setUser(data.user);
  ...
  const handleChangePassword = async (e) => {
    ...
    setLoading(true);
    try {
      const { data } = await api.put('/auth/me/password', { currentPassword: passData.oldPassword, newPassword: passData.newPassword });
